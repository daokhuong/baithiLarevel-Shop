                ...
                <div class="ht-left">
                    <div class="mail-service">
                        <i class="fa fa-envelope"></i>
                            daodinhkhuong@gmail.com
                    </div>
                    <div class="phone-service">
                        <a href="tel:+84 65.42.2424"><i class="fa fa-phone"></i>+84 65.42.2424</a>
                    </div>
                </div>
                <div class="ht-right">
                    @if (Auth::check())
                    ...
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            ...
                            All rights reserved | This template is made with <i class="fa fa-heart-o"
                                aria-hidden="true"></i> by <a href="DucOnline.vn" target="_blank">DucOnline</a>
                        </div>
